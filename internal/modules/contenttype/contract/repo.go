...
type ArticleModelRepo interface {
    ...
    ReplaceSchema(ctx context.Context, id jsontype.SafeUint64, data []*model.ContentTypeSchema) error
    ...
    FindByID(ctx context.Context, id jsontype.SafeUint64) (*model.ContentType, error)
    FindAllSchema(ctx context.Context, modelID jsontype.SafeUint64) ([]*model.ContentTypeSchema, error)
    DeleteModel(ctx context.Context, modelID jsontype.SafeUint64) error
    DeleteSchema(ctx context.Context, id jsontype.SafeUint64) (gen.ResultInfo, error)
    DeleteAllSchema(ctx context.Context, id jsontype.SafeUint64) error
    DeleteArticleData(ctx context.Context, articleID jsontype.SafeUint64) error
