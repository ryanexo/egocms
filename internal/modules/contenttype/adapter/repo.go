...
func NewArticleModelRepo(persist *gquery.Query) contract.ArticleModelRepo {
    return &articleModelRepo{persist}
}

func (r *articleModelRepo) CloneWithQuery(q *gquery.Query) contract.ArticleModelRepo {
