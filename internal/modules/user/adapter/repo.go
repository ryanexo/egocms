...
import (
    ...
    "cms/internal/modules/user/contract"
...
func NewUserRepo(persist *gquery.Query) contract.UserRepo {
    return &userRepo{persist}
}

func (r *userRepo) CloneWithQuery(q *gquery.Query) contract.UserRepo {
