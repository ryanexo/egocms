...
func (s FileService) Save(ctx context.Context, user *model2.User, params dto.FileSaveCommand) (*dto.FileInfo, error) {
    ...
    fileRecord := &model2.File{
        UserID:       user.ID,
        OriginalName: params.Name,
        Ext:          fileExt,
        Path:         savingKey,
        Size:         datatype2.SafeInt64(fileSize),
...
func (s FileService) Delete(ctx context.Context, id datatype2.SafeUint64) error {
...
func (s FileService) openFileReaderByRecord(ctx context.Context, fileRecord *model2.File) (io.ReadCloser, *dto.FileMeta, error) {
    driver, err := s.driverSrv.GetDriver(fileRecord.Driver)
    if err != nil {
        return nil, nil, err
    }
...
func (s FileService) OpenFileRecordByID(ctx context.Context, id datatype2.SafeUint64) (io.ReadCloser, *dto.FileMeta, error) {
    fileRecord, err := s.repo.FindByID(ctx, id)
    if err != nil {
        return nil, nil, err
    }
