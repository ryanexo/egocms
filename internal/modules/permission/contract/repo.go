...
type PermissionRepo interface {
    ...
    FindByID(ctx context.Context, id jsontype.SafeUint64) (*model.Permission, error)
    FindByMenuID(ctx context.Context, id jsontype.SafeUint64) ([]*model.Permission, error)
