...
func newPermission(db *gorm.DB, opts ...gen.DOOption) permission {
	...
	_permission.MenuID = field.NewUint64(tableName, "menu_id")
...
type permission struct {
	...
	MenuID      field.Uint64 // '归类到指定菜单ID,未填写为通用权限'
	Name        field.String
...
func (p *permission) updateTableName(table string) *permission {
	...
	p.MenuID = field.NewUint64(table, "menu_id")
