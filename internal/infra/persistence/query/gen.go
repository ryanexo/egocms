...
func Use(db *gorm.DB, opts ...gen.DOOption) *Query {
	return &Query{
		...
		UploadRecords:        newUploadRecords(db, opts...),
...
func (q *Query) clone(db *gorm.DB) *Query {
	return &Query{
		...
		UploadRecords:        q.UploadRecords.clone(db),
...
func (q *Query) ReplaceDB(db *gorm.DB) *Query {
	return &Query{
		...
		UploadRecords:        q.UploadRecords.replaceDB(db),
...
func (q *Query) WithContext(ctx context.Context) *queryCtx {
	return &queryCtx{
		...
		UploadRecords:        q.UploadRecords.WithContext(ctx),
