...
type Article struct {
    ...
    CategoryID  uint64                `gorm:"index;comment:'文章份额里'"`
    Category    *Category             `gorm:"foreignKey:ID;referenceKey:CategoryID"`
    AuthorID    uint64                `gorm:"index;comment:'文章作者'"`
    ...
    ClickCount  uint64                `gorm:"not null;default:0;comment:'点击数'"`
    ...
    ModelID     *uint64               `gorm:"index;comment:'内容模型'"`
