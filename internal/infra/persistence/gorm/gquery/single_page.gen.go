...
func newSinglePage(db *gorm.DB, opts ...gen.DOOption) singlePage {
	...
	_singlePage.ID = field.NewUint64(tableName, "id")
	_singlePage.CreatedAt = field.NewTime(tableName, "created_at")
	_singlePage.UpdatedAt = field.NewTime(tableName, "updated_at")
	_singlePage.DeletedAt = field.NewField(tableName, "deleted_at")
	_singlePage.Name = field.NewString(tableName, "name")
	_singlePage.Keywords = field.NewString(tableName, "keywords")
...
func (s *singlePage) updateTableName(table string) *singlePage {
	...
	s.Keywords = field.NewString(table, "keywords")
