...
var _ categoryRepo = (domain.CategoryRepo)(nil)

type categoryRepo struct {
    q *query.Query
}

func (s *categoryRepo) Create(ctx context.Context, category *domain.Category) (uint64, error) {
    // TODO implement me
    panic("implement me")
}

func (s *categoryRepo) Update(ctx context.Context, category *domain.Category) error {
    // TODO implement me
    panic("implement me")
}

func (s *categoryRepo) Delete(ctx context.Context, category *domain.Category) error {
    // TODO implement me
    panic("implement me")
}

func (s *categoryRepo) Find(ctx context.Context, id uint64) (*domain.Category, error) {
    // TODO implement me
    panic("implement me")
}

func (s *categoryRepo) CreateSubtree(ctx context.Context, id uint64) error {
    // TODO implement me
    panic("implement me")
}

func (s *categoryRepo) Move(ctx context.Context, category *domain.Category, ancestor *domain.Category) error {
    // TODO implement me
    panic("implement me")
}
...
func (s *categoryRepo) Create(ctx context.Context, data *domain.Category) (uint64, error) {
    m := model.Category{
    ...
    err := s.q.Category.WithContext(ctx).Create(&m)
    if err != nil {
        return 0, err
    }
    return m.ID, nil
