...
import (
    ...
    contract2 `cms/internal/domain/user/contract`
    `cms/internal/domain/user/internal/assembler`
    `cms/internal/domain/user/internal/dto`
    `cms/internal/domain/user/internal/errno`
