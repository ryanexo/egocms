...
var _ article.ArticleRepo = (*articleRepo)(nil)

func NewArticleRepo(persist *query.Query) article.ArticleRepo {
    return articleRepo{persist}
}

func (s articleRepo) CloneWithQuery(q *query.Query) article.ArticleRepo {
