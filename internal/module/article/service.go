...
import (
    ...
    `cms/internal/domain/article/internal/assembler`
    `cms/internal/domain/article/internal/domain`
    `cms/internal/domain/article/internal/dto`
...
func NewArticleService(txManager contract.Transactor, articleRepo ArticleRepo, articleModelRepo ArticleModelRepo) *ArticleService {
...
func (s ArticleService) ChangeStatus(ctx context.Context, id datatype.SafeUint64, action func(status *domain.ArticleStatus) error) error {
