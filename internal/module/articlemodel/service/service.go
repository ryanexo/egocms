...
import (
    ...
    `cms/internal/domain/articlemodel/internal/assembler`
...
type ArticleModelService struct {
    ...
    repo      article.ArticleModelRepo
}

func NewArticleModelService(txManager contract.Transactor, repo article.ArticleModelRepo) *ArticleModelService {
